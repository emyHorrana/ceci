...
//
// `temJogo: false` sinaliza as 3 Unidades que hoje não têm NENHUMA
// etapa tipo 'jogo' dentro dos mini-módulos que a compõem — ou seja,
// o BKT nunca vai receber uma observação real pra elas até a equipe
// decidir o que fazer (ver as 3 opções discutidas com o time).
// A FilaDePendencias deve tratar `temJogo: false` como "não entra na
// fila de pendência automaticamente" até essa decisão ser tomada.
...
const unidades = [
  ...
  { id: 'U2.1', moduloId: '2', tier: 1, ordem: 0, prerequisitos: [], miniModulos: ['2-1', '2-2'], temJogo: false }, // ⚠️ só teoria
  ...
  { id: 'U3.1', moduloId: '3', tier: 2, ordem: 0, prerequisitos: [], miniModulos: ['3-1', '3-2'], temJogo: false }, // ⚠️ só teoria
  ...
  { id: 'U3.6', moduloId: '3', tier: 2, ordem: 5, prerequisitos: ['U3.4', 'U3.5'], miniModulos: ['3-10', '3-11'], temJogo: false }, // ⚠️ só teoria
];
